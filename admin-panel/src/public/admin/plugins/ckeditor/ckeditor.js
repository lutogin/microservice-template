            ...
            for (
              ...
              if (
                ...
                f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                  (m.type == CKEDITOR.NODE_ELEMENT && !t[f.name][m.name]) &&
    ...
    function a(a, c, g, n) {
      ...
      i.on('loaded', function() {
        ...
        n == CKEDITOR.ELEMENT_MODE_REPLACE &&
          (i.config.autoUpdateElement && a.$.form) &&
          i._attachToForm();
        ...
        return function(h, j, o) {
          ...
          if (!x.checkReadOnly()) {
            ...
            if (!q.collapsed) {
              ...
              v &&
                (!v.equals(X) && !v.contains(X) && q.checkEndOfBlock()) &&
                j.zombies.push(v);
              q.deleteContents();
            }
            for (
        ...
        function c(a) {
          ...
          for (b; b-- > 0; ) {
            ...
            if (!CKEDITOR.tools.trim(e.getHtml())) {
              e.appendBogus();
              CKEDITOR.env.ie &&
                (CKEDITOR.env.version < 9 && e.getChildCount()) &&
                e.getFirst().remove();
            }
          }
        }
